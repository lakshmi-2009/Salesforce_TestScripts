...
public class TC_17_OportunityPipelineLink extends BaseTestSalesforce {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(3000);
		By OppPipeLine = By.xpath("//*[@id=\"toolsContent\"]/tbody/tr/td[1]/div/div[1]/div[1]/ul/li[1]/a");
		WebElement OpportunityPipeline = driver.findElement(OppPipeLine);
		clickOnButton(OpportunityPipeline, OppPipeLine);
